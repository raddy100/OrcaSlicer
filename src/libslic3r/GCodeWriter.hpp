...
public:
    ...
    std::string travel_to_z_with_speed(double z, double speed, const std::string &comment = std::string(), bool force = false);
  ...
  private:
    ...
    std::string _travel_to_z_with_speed(double z, double speed, const std::string &comment);
